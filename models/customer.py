...
class CustomerModel(db.Model):
    ...
    CustomerID = db.Column(db.NVARCHAR(1000))
    SwiftCode = db.Column(db.NVARCHAR(50))
    Name = db.Column(db.NVARCHAR)
    FullName = db.Column(db.NVARCHAR)
    AdditionalFullName = db.Column(db.NVARCHAR)
    Address = db.Column(db.NVARCHAR)
    AdditionalAddress = db.Column(db.NVARCHAR)
    City = db.Column(db.NVARCHAR)
    Country = db.Column(db.NVARCHAR(255))
    BISStatus = db.Column(db.NVARCHAR(255))
    BusinessStatus = db.Column(db.NVARCHAR(255))
    Parent = db.Column(db.NVARCHAR(255))
