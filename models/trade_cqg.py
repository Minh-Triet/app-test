...
class TradeCQG(db.Model):
    ...
    MessageRaw = db.Column(db.String)
    ...
    ExecTransType = db.Column(db.String)
    ...
    OrdStatus = db.Column(db.String)
    OrdType = db.Column(db.String)
    ...
    CustOrderHandlingInst = db.Column(db.String)
