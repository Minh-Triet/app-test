...
class TradeCQG(db.Model):
    ...
    BeginString = db.Column(db.String)
    OnBehalfOfCompID = db.Column(db.String)
    ...
    ExecID = db.Column(db.String)
    ExecTransType = db.Column(db.NVARCHAR)
    IDSource = db.Column(db.String)
    ...
    OrdType = db.Column(db.NVARCHAR)
    Price = db.Column(db.DECIMAL(18, 8))
    SecurityID = db.Column(db.String)
    Side = db.Column(db.NVARCHAR)
    Symbol = db.Column(db.String(64))
    TimeInForce = db.Column(db.NVARCHAR)
    TransactTime = db.Column(db.DateTime)
    ExecType = db.Column(db.NVARCHAR)
    LeavesQty = db.Column(db.DECIMAL(18, 4))
    SecurityType = db.Column(db.String)
    SecondaryOrderID = db.Column(db.String)
    MaturityMonthYear = db.Column(db.String)
    MaturityDay = db.Column(db.Integer)
    SecurityExchange = db.Column(db.String)
    MaturityDate = db.Column(db.DateTime)
    ManualOrderIndicator = db.Column(db.Boolean)
    StatementDate = db.Column(db.DateTime)
    OrderSource = db.Column(db.String(24))
    TradeID = db.Column(db.String)
    ChainOrderID = db.Column(db.String)
    ...
    MifidExecutionDecision = db.Column(db.String)
    ...
    ContractMonthYear = db.Column(db.String)
    SecondaryClOrderID = db.Column(db.String)
    ClearingBusinessDate = db.Column(db.DateTime)
    SecuritySubType = db.Column(db.String)
    CustOrderHandlingInst = db.Column(db.NVARCHAR)
