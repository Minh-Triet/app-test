...
class TradeModel(db.Model):
    ...
    insaddr_insid = db.Column(db.String(255))
    curr_insid = db.Column(db.String(255))
    quantity = db.Column(db.DECIMAL(18, 4))
    acquirer_ptynbr_ptyid = db.Column(db.String(255))
    counterparty_ptynbr_ptyid = db.Column(db.String(255))
    owner_usrnbr_userid = db.Column(db.String(255))
    prfnbr_prfid = db.Column(db.String(255))
    MessageBuilder = db.Column(db.String(100))
    ResponseFromAMB = db.Column(db.String(100))
